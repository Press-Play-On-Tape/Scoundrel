...
convert_header(IMAGES + 'Cards/Hand_Full.png',                                      BASE + 'Images.hpp', 'Hand_Full', 4, 17, 24)
convert_header(IMAGES + 'Cards/Hand_Full_Grey.png',                                 BASE + 'Images.hpp', 'Hand_Full_Grey', 4, 17, 24)
...
convert_header(IMAGES + 'Extras/Background.png',                                    BASE + 'Images.hpp', 'Background', 4)
convert_header(IMAGES + 'Extras/Equip.png',                                         BASE + 'Images.hpp', 'Equip', 4, 61, 24)
convert_header(IMAGES + 'Extras/BurnCard.png',                                      BASE + 'Images.hpp', 'BurnCard', 4, 53, 24)
convert_header(IMAGES + 'Extras/RestoreHealth.png',                                 BASE + 'Images.hpp', 'RestoreHealth', 4, 70, 24)
convert_header(IMAGES + 'Extras/ChooseFight.png',                                   BASE + 'Images.hpp', 'ChooseFight', 4, 74, 40)
...
convert_header(IMAGES + 'Extras/Puff_00.png',                                       BASE + 'Images.hpp', 'Puff_00', 4, 32, 32)
convert_header(IMAGES + 'Extras/Puff_01.png',                                       BASE + 'Images.hpp', 'Puff_01', 4, 32, 32)
convert_header(IMAGES + 'Extras/Run.png',                                           BASE + 'Images.hpp', 'Run', 4, 17, 16)
convert_header(IMAGES + 'Extras/Sword.png',                                         BASE + 'Images.hpp', 'Sword', 4, 32, 32)
convert_header(IMAGES + 'Extras/YouLose.png',                                       BASE + 'Images.hpp', 'YouLose', 4)
